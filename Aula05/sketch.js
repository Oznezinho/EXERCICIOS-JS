...
//02 - Criar a função RENDER
//03 - Criar a função TURN com as setas do teclado
//04 - Criar a função de bordas
...
function preload(){
  fundo = loadImage('img/Space.png');
}

function setup() {
  createCanvas(400, 400);
  nave = new Nave(R,G,B);
  nave2 = new Nave(0,255,0);
...
function placar(){
  ...
  text('P1:' + meusPontos,15,30);
  text('P1:' + pontosOponente,350,30);
  pop();
}